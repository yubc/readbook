...
var (
	...
	RankIdURL     = "http://api.zhuishushenqi.com/ranking/%s"                                                                //获取排行榜小说
	CatsURL       = "http://api.zhuishushenqi.com/cats/lv2"                                                                  //获取分类下小类型
	CategoriesURL = "https://api.zhuishushenqi.com/book/by-categories?gender=%s&type=%s&major=%s&minor=%s&start=%s&limit=%s" //根据分类获取小说列表
	...
	// MixAtocURL    = "http://api.zhuishushenqi.com/mix-atoc/%s?view=%s"                                                       //获取小说章节(根据小说id)
	SourceURL = "http://api.zhuishushenqi.com/atoc/%s?view=%s" //获取小说章节(根据小说源id)
	...
	SearchHotWord = "http://api.zhuishushenqi.com/book/search-hotword" //获取热词
